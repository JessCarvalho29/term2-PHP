...
// Getting the editId from the index.php page and calling the displayRecordById function to show the correct informations in the Input
        ...
        <div class="card">
          ...
          <div class="card-body bg-light">
            ...
            // Update Record in customer table
              if(!empty($_POST)) {
                // passing the name of the form with updated values
                $uname = $_POST['uname'];
                $uemail = $_POST['uemail'];
                $usalary = $_POST['usalary'];
                // Saving the value of customer id in $id (get from index.php and saved in $customer variable)
                $id = $customer['id'];
