...
<body>
	...
	<main class="container">
		<section class="form-row row justify-content-center">
			...
			<!--We defined in the form that we want to use the method post  -->
			...
			<div class="form-group submit-message">
				<?php
					...
					if(!empty($_POST)){
						// key: attibut_name_value of all the input elements in the form
						// syntax: variable = method POST[key]
						// fetching/getting all the values
						$fname = $_POST['fname'];
						$lname = $_POST['lname'];
						$age = $_POST['age'];
						$email = $_POST['email'];
						// run the insert query
						// Saving the return inside 'res' (true or false)
						// syntax: name of the object -> call the function (parameters)
